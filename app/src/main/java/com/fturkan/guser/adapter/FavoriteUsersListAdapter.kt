...
class FavoriteUsersListAdapter: RecyclerView.Adapter<FavoriteUsersListAdapter.FavoriteUsersListViewHolder>() {
    ...
    inner class FavoriteUsersListViewHolder(val binding: UserListRowBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(user: User){
            binding.apply {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoriteUsersListViewHolder {
        val view = UserListRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return FavoriteUsersListViewHolder((view))
    }

    override fun onBindViewHolder(holder: FavoriteUsersListViewHolder, position: Int) {
